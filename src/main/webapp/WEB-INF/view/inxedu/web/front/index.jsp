			...
			<section class="container">
				...
				<div>
					<section class="c-tab-title">
						<a href="javascript:void(0)" title="课程精选" onclick="bna('FOLLOW',this)" class="current boutiqueCourse">课程精选</a>
						<%--<a href="javascript:void(0)" title="课程精选" onclick="bna('NEW',this)">最新课程</a>--%>
